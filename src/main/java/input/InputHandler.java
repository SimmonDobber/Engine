...
import threader.thread.ParallelThread;

public class InputHandler implements common.Observable, InputObservable {
    ...
    private final List<common.Observer> observers;
    ...
    public boolean isActive(InputElement inputElement) {
    ...
    @Override
    public void attach(common.Observer observer) {
        this.observers.add(observer);
    }

    @Override
    public void detach(common.Observer observer) {
